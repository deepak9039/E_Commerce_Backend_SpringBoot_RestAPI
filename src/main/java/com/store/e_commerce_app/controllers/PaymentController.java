...
public class PaymentController {
    ...
    public ProductOrder processOrderDetails(@RequestBody UserPaymentDetails request) {
        return paymentService.getOrderDetails(request);
    }

    @PostMapping("/payment-details")
    public Payment paymentDetails(@RequestBody UserPaymentDetails request) {
